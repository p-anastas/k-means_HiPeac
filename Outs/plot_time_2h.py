...
res68=[]
res68e=[]
with open('testnovec_2h.out') as file:#with open('serialnovec.out') as file:
	list1 = file.readlines()
with open('testnovec_2h.out') as file:
	list2 = file.readlines()
with open('final_vec_mem_2h.out') as file:
...
ax.set_title("Varied Cluster number(128MB)")
ax.legend(prop={'size':10},loc=2)
plt.savefig("Varied_cluster_number(128MB).png", bbox_inches='tight')
plt.close()
