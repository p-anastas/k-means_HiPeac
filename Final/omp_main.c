...
int main(int argc, char **argv) {
    ...
    timer = omp_kmeans(is_perform_atomic, objects, numCoords, numObjs,
	...
	if (is_output_timing) {
        ...
        printf("Atom=%d I/O_time=%f Comp_time=%f File=%s Threads=%d Items=%d Dims=%d Clusters=%d\n",is_perform_atomic, io_timing, timer,  filename, omp_get_max_threads(), numObjs, numCoords, numClusters);
    }
