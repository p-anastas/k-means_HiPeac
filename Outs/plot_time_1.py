...
rng=[100.0]
dims=[16]
elems=[65536/2,65536,65536*2,65536*4,65536*8,65536*16,65536*32]
resSeq=[]
res68=[]
res68e=[]
with open('serialnovec_1.out') as file:#with open('serialnovec.out') as file:
	list1 = file.readlines()
with open('testnovec_1.out') as file:
	list2 = file.readlines()
with open('final_vec_mem_1.out') as file:
...
rects68 = ax.bar(ind, res68, width, color='c',label='68 cores baseline')
rects68e = ax.bar(ind + width +0.05 , res68e, width, color='m',label='68 cores final')
...
ax.set_title("Varied object number Speedup")
ax.legend(prop={'size':10},loc=2)
plt.savefig("Varied_object_number_speedup.png", bbox_inches='tight')
plt.close()
